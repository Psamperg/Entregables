...
Este repositorio contiene soluciones a ejercicios de Python, incluyendo funciones, clases y programas interactivos.

## Contenido
- `ejercicios.py` → Soluciones en Python
...
[Modulo4_Entrega_Phyton.py](https://github.com/user-attachments/files/22198180/Modulo4_Entrega_Phyton.py)
# %%
